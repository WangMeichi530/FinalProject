...
/**
 * Parameter configuration Information handling
 * 
 * @author ruoyi
 */
@RestController
...
public class SysConfigController extends BaseController
{
    ...
    /**
     * Get a list of parameter configurations
     */
    ...
    public void export(HttpServletResponse response, SysConfig config)
    {
        ...
        util.exportExcel(response, list, "Parametric data");
    }

    /**
     * Get details by parameter number
     */
    ...
    /**
     * Querying the value of a parameter by its key name
     */
    ...
    public AjaxResult edit(@Validated @RequestBody SysConfig config)
    {
        if (UserConstants.NOT_UNIQUE.equals(configService.checkConfigKeyUnique(config)))
        {
            return AjaxResult.error("change parameter'" + config.getConfigName() + "'Failed, parameter key name already exists");
        }
