...
public class SysDictTypeController extends BaseController
{
    ...
    public AjaxResult add(@Validated @RequestBody SysDictType dict)
    {
        ...
        {
            return AjaxResult.error("AddDictionary '" + dict.getDictName() + "'Failed, Dictionary type already exists");
        }
    ...
    public AjaxResult edit(@Validated @RequestBody SysDictType dict)
    {
        if (UserConstants.NOT_UNIQUE.equals(dictTypeService.checkDictTypeUnique(dict)))
        {
            return AjaxResult.error("changeDictionary '" + dict.getDictName() + "'Failed, Dictionary type already exists");
        }
    ...
    /**
     * Refreshing the Dictionary cache
     */
    @PreAuthorize("@ss.hasPermi('system:dict:remove')")
    ...
    /**
     * Get a list of Dictionary checkboxes
     */
