<template>
  <div id="tags-view-container" class="tags-view-container">
    ...
    <ul v-show="visible" :style="{left:left+'px',top:top+'px'}" class="contextmenu">
      <li @click="refreshSelectedTag(selectedTag)"><i class="el-icon-refresh-right"></i> reNewpage面</li>
      ...
      <li @click="closeAllTags(selectedTag)"><i class="el-icon-circle-close"></i> 全部Close</li>
    </ul>
  </div>
</template>
