  ...
  <el-dialog title="Import表" :visible.sync="visible" width="800px" top="5vh" append-to-body>
    ...
    <el-row>
      <el-table @row-click="clickRow" ref="table" :data="dbTableList" @selection-change="handleSelectionChange" height="260px">
        ...
        <el-table-column prop="tableName" label="表Name" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="tableComment" label="表描述" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="createTime" label="Create Time"></el-table-column>
        <el-table-column prop="updateTime" label="更New时间"></el-table-column>
      </el-table>
      <pagination
        v-show="total>0"
        :total="total"
    ...
    <div slot="footer" class="dialog-footer">
      <el-button type="primary" @click="handleImportTable">Sure</el-button>
