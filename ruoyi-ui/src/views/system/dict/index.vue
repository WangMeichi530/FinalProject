  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="Dictionary Name" prop="dictName">
        <el-input
          ...
          placeholder="Please InputDictionary Name"
          clearable
          size="small"
          style="width: 240px"
      ...
      <el-form-item label="Dictionary type" prop="dictType">
        <el-input
          ...
          placeholder="Please InputDictionary type"
          clearable
          size="small"
          style="width: 240px"
          @keyup.enter.native="handleQuery"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="Dictionary Name" prop="dictName">
          <el-input v-model="form.dictName" placeholder="Please InputDictionary Name" />
        </el-form-item>
        <el-form-item label="Dictionary type" prop="dictType">
          <el-input v-model="form.dictType" placeholder="Please InputDictionary type" />
        </el-form-item>
        <el-form-item label="Status" prop="status">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        dictName: [
          { required: true, message: "Dictionary Namecannot be empty", trigger: "blur" }
        ],
        dictType: [
          { required: true, message: "Dictionary typecannot be empty", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getType(dictId).then(response => {
        ...
        this.open = true;
        this.title = "changeDictionary type";
      });
    },
    /** Submitbutton */
    submitForm: function() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('YesNoconfirmDeleteDictionary Numberis"' + dictIds + '"data？').then(function() {
